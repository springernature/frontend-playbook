...
Use the [`createEvent` module]([https://github.com/springernature/frontend-toolkits/tree/master/toolkits/global/packages/global-javascript#createevent](https://github.com/springernature/frontend-toolkits/tree/master/context/brand-context/default/js#createevent)) from the Springer Nature Elements toolkit. This module functions as a namespaced wrapper around Javascript `customEvent`.
