...
```html
<button class="c-button" data-component-collapse-toggle="header-menu">Menu</button>
<nav class="c-header-menu u-hidden" data-component-collapse-togglable="header-menu">
    (etc.)
</nav>
```
