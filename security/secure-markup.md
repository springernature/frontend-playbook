...
**Nov 2020 update**: [Chrome 88+](https://chromium-review.googlesource.com/c/chromium/src/+/1630010) will match Safari and Firefox's behavior of treating `target=_blank` links as `noopener` by default.
