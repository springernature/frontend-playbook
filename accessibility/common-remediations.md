...
Words are pronounced differently in different languages. Screen reader software is designed to respect these pronouncation differences when it encounters web pages that specify their main language. 
...
Words are pronounced differently in different languages. Screen reader software is designed to respect these pronouncation differences when it encounters components on web pages that specify a change in language. 
